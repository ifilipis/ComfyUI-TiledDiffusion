        ...
        for tile_index, bbox in enumerate(bboxes):
            ...
            for batch_offset in range(batch_size):
                ...
                if self.model_backend == "wan":
                    time_offset = getattr(bbox, "t", 0)
                    tile_offset["offset_t"] = time_offset
